...
public interface SaleRepository extends JpaRepository<Sale, Long> {
	...
	Page<SaleMinDTO> searchDateAndSeller(LocalDate minDate, LocalDate maxDate, String sellerName, Pageable pageable);
	...
	@Query("SELECT new com.devsuperior.dsmeta.dto.SellerMinDTO(s.seller.name AS sellerName, SUM(s.amount) AS totalAmount) " +
		...
		List<SellerMinDTO> searchDate(@Param("minDate") LocalDate minDate, @Param("maxDate") LocalDate maxDate);
}
